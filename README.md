# 💫 About Me:
¡Hola a todos! 👋 Soy Andy, una persona curiosa "based on" La Plata, Buenos Aires (Arg), que ha decidido embarcarse en un viaje hacia el mundo de la programación: descubrí mi pasión en las matemáticas aplicadas y el código Python para la resolución de problemas. <br><br> Me motiva participar en proyectos que tengan un impacto significativo en la esfera social,  lo que se suele llamar "Data Science for Wellbeing". Creo firmemente en el poder transformador de la tecnología para abordar y resolver cuestiones de alta relevancia en el mundo real, y estoy comprometida a contribuir con mi grano de arena.<br><br> Mi mentalidad inquisitiva facilita sumergirme en el vasto mundo del desarrollo, siempre buscando aprender y crecer tanto personal como profesionalmente. Estoy lista para enfrentar nuevos desafíos y contribuir al éxito de propósitos ambiciosos, y que, eventualmente, me permitan conocer buenos equipos de trabajo. Colaborar en proyectos interesantes y desafiantes es algo que me emociona. <br><br>Si buscas a alguien entusiasta, orientado a resultados y con un enfoque riguroso, ¡no dudes en conectarte conmigo! 
