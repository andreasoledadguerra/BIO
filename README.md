# 💫 About Me:
¡Hola a todos! 👋 Soy Andy, una persona curiosa "based on" La Plata, Buenos Aires (Arg), que ha decidido embarcarse en un viaje hacia el mundo de la programación. Después de cambiar de industria, encontré mi verdadera pasión en las matemáticas y el código Python para la resolución de problemas tecnológicos.<br><br>Mi motivación radica en participar activamente en proyectos que tengan un impacto significativo en las esferas social, económica y ambiental,  lo que se suele llamar "Data Science for Well Being". <br><br> Me encantan los idiomas (sé inglés, y estoy aprendiendo japonés y coreano), el ajedrez, leer haiku, practicar esgrima (¡los deportes me divierten!),  hacer running, y sobre todo me encanta la comida plant based 🌱.
